  ...
  return (
    <div className="guide-main-container">
      ...
      <div className="guide-branches">
        ...
        <ExerciseInfo question={sampleQuestion} infoType="line" />
        <ExerciseInfo
          question={sampleBranches[branchCount].shapes}
          lines={sampleBranches[branchCount].lines}
          Finish={HandleBranchFinished}
        />
        <IconButton
          aria-label="next"
          style={{ dropShadow: "1px 3px 19px #9e9e9e" }}
